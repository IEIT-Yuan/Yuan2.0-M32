        ...
        **model_init_kwargs,
        ...
        if max_memory:
            ...
            with accelerate.init_empty_weights():
                model = YuanForCausalLM._from_config(config)
                #model = YuanForCausalLM.from_config(config, trust_remote_code=True)
            model.tie_weights()
        ...
        model = YuanForCausalLM.from_pretrained(pretrained_model_name_or_path, **merged_kwargs)
        ...
        **kwargs,
        ...
        if not use_qigen:
            ...
            with ContextManagers(init_contexts):
                model = YuanForCausalLM._from_config(
            ...
            model = YuanForCausalLM.from_config(
